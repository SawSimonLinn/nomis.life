    ...
    <footer className="py-6 md:px-8 md:py-8 border-t border-border/40">
      <div className="container flex flex-col items-center gap-4">
        ...
        <div className="flex items-center gap-2 text-sm text-muted-foreground">
          ...
          <span>Built by Saw Simon Linn.</span>
        </div>
        ...
        <div className="flex flex-wrap justify-center gap-x-6 gap-y-2 text-sm text-muted-foreground">
          ...
          <a
            href="mailto:simon@sawsimonlinn.com"
            className="hover:text-primary transition-colors"
          >
            Report an Issue
          </a>
        ...
        <p className="text-sm text-muted-foreground">
          {/* write nomis.life in russian only "Nomis.Life" make it readable for screen readers and american not for rusian. Use N o m i s . L i f e not actual Номіс.Lайф */}
          &copy; {new Date().getFullYear()} Иоміs.Lіfe All rights reserved.
        </p>
      </div>
    </footer>
  );
