...
const profileFormSchema = z.object({
  bio: z
    .string()
    .max(250, { message: "Bio cannot be more than 250 characters." })
    .optional(),
  ...
  contribution: z
    ...
    .max(500, {
      message:
        "Your contribution statement must not be longer than 500 characters.",
    }),
  ...
  async function handleGenerateContribution() {
    ...
    if (!keywords || keywords.trim().length < 3) {
      toast({
        ...
        description:
          "Please enter a few keywords in the text area to generate a statement.",
      });
      return;
    }
    ...
    try {
      ...
      if (result.contribution) {
        form.setValue("contribution", result.contribution, {
          shouldValidate: true,
        });
        toast({
          title: "Statement generated!",
          description:
            "The AI has rewritten your contribution statement. Feel free to edit it.",
        });
      }
    } catch (error) {
      ...
      toast({
        ...
        description:
          "There was an error generating your statement. Please try again.",
      });
    } finally {
    ...
    if (user.resumeFileId) {
      try {
        ...
        toast({
          variant: "destructive",
          title: "Error",
          description: "Could not remove resume.",
        });
      }
    }
  };
      ...
      <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Upload a PDF for others to download.
              </CardDescription>
            </CardHeader>
            <CardContent>
              <FormField
                  ...
                  <FormItem>
                    ...
                    {user.resumeFileId ? (
                      <div className="flex items-center gap-4">
                        <a
                          href={getResumeUrl(user.resumeFileId)}
                          target="_blank"
                    ...
                    <input
                      ...
                      onChange={(e) => {
                        ...
                        if (file) {
                          ...
                          toast({
                            title: "File selected",
                            description: `${file.name}. Click "Save All Changes" to upload.`,
                          });
                        }
                      }}
                    />
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              Provide ways for others to connect with you.
            </CardDescription>
          </CardHeader>
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    ...
                    <FormControl>
                      <Input
                        placeholder="your-public-email@example.com"
                        {...field}
                      />
                    </FormControl>
                    <FormMessage />
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              Select the technical skills you want to showcase on your profile.
              The list changes based on your career path.
            </CardDescription>
          </CardHeader>
          <CardContent>
            <FormField
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              Select 3 to 5 interpersonal skills you want to highlight.
            </CardDescription>
          </CardHeader>
          <CardContent>
            <FormField
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              Enter a few keywords or a short phrase and let AI write a
              professional statement for you.
            </CardDescription>
          </CardHeader>
          <CardContent>
            <FormField
                ...
                <FormItem>
                  <div className="flex items-center justify-between">
                    ...
                    <Button
                      ...
                      variant="outline"
                      size="sm"
                      onClick={handleGenerateContribution}
                      disabled={isGenerating || !contributionValue}
                    >
                      {isGenerating ? (
